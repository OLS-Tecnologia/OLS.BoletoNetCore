    ...
    internal sealed partial class BancoCaixa : BancoFebraban<BancoCaixa>, IBanco
    {
        ...
        public void FormataBeneficiario()
        {
            ...
            if (!CarteiraFactory<BancoCaixa>.CarteiraEstaImplementada(contaBancaria.CarteiraComVariacaoPadrao))
             ...
             contaBancaria.FormatarDados("EM TODA A REDE BANCÁRIA E SEUS CORRESPONDENTES ATÉ O VALOR LIMITE", "", 
                 "SAC CAIXA: 0800 726 0101 (informações, reclamações, sugestões e elogios)<br>Para pessoas com deficiência auditiva ou de fala: 0800 726 2492<br>Ouvidoria: 0800 725 7474<br>caixa.gov.br<br>", digitosconta);
