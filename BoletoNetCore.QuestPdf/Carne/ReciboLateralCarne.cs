...
namespace OLS.BoletoNetCore.QuestPdf
{
    internal class ReciboLateralCarne : IComponent
    {
        ...
        //}
        private byte[] logo;
        private BoletoViewModel boletoViewModel;

        public ReciboLateralCarne(BoletoViewModel boletoViewModel, byte[] logo)
        {
            this.logo = logo;
            this.boletoViewModel = boletoViewModel;
        }
        ...
        public void Compose(IContainer container)
        {
            container.Stack(stack =>
            {
                ...
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                    ...
                    {
                        st.Item().Text("Parcela", BoletoPdfConstants.LabelStyle);
                        st.Item().Text(this.boletoViewModel.ParcelaInformativo, BoletoPdfConstants.NormalFieldStyle);
                    });

                    row.RelativeColumn().Stack(st =>
                    {
                        st.Item().Text("Vencimento", BoletoPdfConstants.LabelStyle);
                        st.Item().Text(this.boletoViewModel.DataVencimentoFormatada, BoletoPdfConstants.BoldFieldStyle);
                    });
                });
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                    ...
                    {
                        st.Item().Text("Agência / Código Beneficiário", BoletoPdfConstants.LabelStyle);
                        st.Item().AlignRight().Text(this.boletoViewModel.CodigoBeneficiarioFormatado, BoletoPdfConstants.NormalFieldStyle);
                    });
                });
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                    ...
                    {
                        st.Item().Text("Espécie", BoletoPdfConstants.LabelStyle);
                        st.Item().AlignCenter().Text(this.boletoViewModel.EspecieMoeda, BoletoPdfConstants.NormalFieldStyle);
                    });
                ...
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                    ...
                    {
                        st.Item().Text("(=) Valor do Documento", BoletoPdfConstants.LabelStyle);
                        st.Item().AlignRight().Text(this.boletoViewModel.ValorTituloFormatado, BoletoPdfConstants.BoldFieldStyle);
                    });
                });
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                ...
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                    ...
                    {
                        st.Item().Text("Número Documento", BoletoPdfConstants.LabelStyle);
                        st.Item().AlignRight().Text(this.boletoViewModel.NumeroDocumento, BoletoPdfConstants.NormalFieldStyle);
                    });
                });
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                    ...
                    {
                        st.Item().Text("Nosso Número", BoletoPdfConstants.LabelStyle);
                        st.Item().AlignRight().Text(this.boletoViewModel.NossoNumeroFormatado, BoletoPdfConstants.NormalFieldStyle);
                    });
                });
                stack.Item().BorderTop(BoletoPdfConstants.BorderSize).Row(row =>
                {
                    ...
                    {
                        st.Spacing(5);
                        st.Item().Text(this.boletoViewModel.BeneficiarioCompleto, BoletoPdfConstants.LabelStyle);
                        st.Item().Text(this.boletoViewModel.PagadorCompleto, BoletoPdfConstants.LabelStyle);
                    });
                });
            });
        }
