...
namespace BoletoNetCore.Testes
{
    ...
    public class BancoItauCarteira109Tests
    {
        ...
        public void Deve_criar_boleto_itau_109_com_digito_verificador_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
        ...
        [TestCase(500.00, "223349", "BB000005E", "8", "109/00223349-4", "34198731700000500001090022334941234567890000", "34191.09008 22334.941238 45678.900007 8 73170000050000", 2017, 10, 19)]
        [TestCase(300.00, "223347", "BB000003C", "9", "109/00223347-8", "34199725600000300001090022334781234567890000", "34191.09008 22334.781238 45678.900007 9 72560000030000", 2017, 08, 19)]
        public void Deve_criar_boleto_itau_109_com_nosso_numero_formatado_valida(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
            var boleto = new Boleto(_banco)
            {
        ...
        [TestCase(500.00, "223349", "BB000005E", "8", "109/00223349-4", "34198731700000500001090022334941234567890000", "34191.09008 22334.941238 45678.900007 8 73170000050000", 2017, 10, 19)]
        [TestCase(300.00, "223347", "BB000003C", "9", "109/00223347-8", "34199725600000300001090022334781234567890000", "34191.09008 22334.781238 45678.900007 9 72560000030000", 2017, 08, 19)]
        public void Deve_criar_boleto_itau_109_com_codigo_de_barras_valida(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
            var boleto = new Boleto(_banco)
            {
        ...
        [TestCase(500.00, "223349", "BB000005E", "8", "109/00223349-4", "34198731700000500001090022334941234567890000", "34191.09008 22334.941238 45678.900007 8 73170000050000", 2017, 10, 19)]
        [TestCase(300.00, "223347", "BB000003C", "9", "109/00223347-8", "34199725600000300001090022334781234567890000", "34191.09008 22334.781238 45678.900007 9 72560000030000", 2017, 08, 19)]
        public void Deve_criar_boleto_itau_109_com_linha_digitavel_valida(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
            var boleto = new Boleto(_banco)
            {
