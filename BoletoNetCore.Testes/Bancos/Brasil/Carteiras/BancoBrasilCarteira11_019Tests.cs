...
namespace BoletoNetCore.Testes
{
    ...
    public class BancoBrasilCarteira11019Tests
    {
        ...
        [TestCase(350, "12345670047850002", "654321LA", "1", "12345670047850002", "00191848500000350000000001234567004785000211", "00190.00009 01234.567004 47850.002115 9 66530000035000", 2020, 12, 30)]
        public void Deve_criar_boleto_brasil_11_019_com_digito_verificador_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
        ...
        [TestCase(1200, "", "321as1234", "7", "00000000000000000", "00197739100001200000000000000000000000000011", "00190.00009 00000.000000 00000.000117 7 73910000120000", 2018, 1, 1)]
        [TestCase(791, "12345679999999901", "654321VW", "8", "12345679999999901", "00198782400000791000000001234567999999990111", "00190.00009 01234.567996 99999.901111 8 78240000079100", 2019, 3, 10)]
        [TestCase(350, "12345670047850002", "654321LA", "9", "12345670047850002", "00191848500000350000000001234567004785000211", "00190.00009 01234.567004 47850.002115 9 66530000035000", 2020, 12, 30)]
        public void Deve_criar_boleto_brasil_11_019_com_nosso_numero_formatado_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
            var boleto = new Boleto(_banco)
            {
        ...
        [TestCase(791, "12345679999999901", "654321VW", "8", "12345679999999901", "00198782400000791000000001234567999999990111", "00190.00009 01234.567996 99999.901111 8 78240000079100", 2019, 3, 10)]
        [TestCase(350, "12345670047850002", "654321LA", "9", "12345670047850002", "00191848500000350000000001234567004785000211", "00190.00009 01234.567004 47850.002115 9 66530000035000", 2020, 12, 30)]
        public void Deve_criar_boleto_brasil_11_019_com_codigo_de_barras_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
            var boleto = new Boleto(_banco)
            {
        ...
        [TestCase(1200, "", "321as1234", "7", "00000000000000000", "00197739100001200000000000000000000000000011", "00190.00009 00000.000000 00000.000117 7 73910000120000", 2018, 1, 1)]
        [TestCase(791, "12345679999999901", "654321VW", "8", "12345679999999901", "00198782400000791000000001234567999999990111", "00190.00009 01234.567996 99999.901111 8 78240000079100", 2019, 3, 10)]
        [TestCase(350, "12345670047850002", "654321LA", "9", "12345670047850002", "00191848500000350000000001234567004785000211", "00190.00009 01234.567004 47850.002115 1 84850000035000", 2020, 12, 30)]
        public void Deve_criar_boleto_brasil_11_019_com_linha_digitavel_valida(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
            var boleto = new Boleto(_banco)
            {
